...
class CoinsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create coin" do
    assert_difference('Coin.count') do
      post coins_url, params: { coin: { acronym: @coin.acronym, description: @coin.description, img_url: @coin.img_url } }
    end
  ...
  test "should update coin" do
    patch coin_url(@coin), params: { coin: { acronym: @coin.acronym, description: @coin.description, img_url: @coin.img_url } }
